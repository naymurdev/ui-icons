...
import { ArrowUpRight, Blocks, Component } from 'lucide-react';
        ...
        <div className='relative z-10'>
          ...
          <div className='grid grid-cols-3 relative'>
            {allProjects.map((project, index) => (
              <div key={project.id}>
                <div
                  className={`relative ${index === allProjects.length - 1 ? 'pr-0 2xl:pr-0 lg:pr-0' : '2xl:pr-10 lg:pr-7 pr-5 '}`}
